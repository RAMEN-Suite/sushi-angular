...
- [x] `suiStatus` wraps DaisyUI `status`
      Basis: DaisyUI `status`

- [x] `suiKbd` wraps DaisyUI `kbd`
      Basis: DaisyUI `kbd`

- [x] `suiAvatar` wraps DaisyUI `avatar`
      Basis: DaisyUI `avatar`

- [x] `suiIndicator` wraps DaisyUI `indicator`
      Basis: DaisyUI `indicator`

- [x] `suiAutoFocus` replaces `primeng/autofocus`
      Basis: Angular CDK a11y / FocusMonitor or native focus

- [x] `suiCard` replaces simple panel/card usage  
      Basis: DaisyUI `card`

- [x] `suiMessage` replaces `primeng/message`
      Basis: DaisyUI `alert`

- [x] `suiToggleButton` replaces `primeng/togglebutton`
