...
suiInputGroup          replaces primeng/inputgroup, primeng/inputgroupaddon
...
suiInplace             replaces primeng/inplace
```
...
suiMenubar             replaces primeng/menubar
suiPanelMenu           replaces primeng/panelmenu
suiBreadcrumb          replaces primeng/breadcrumb
suiColorPicker         replaces primeng/colorpicker
suiSegmentedControl    replaces primeng/selectbutton
```

types / config replacements
```
SuiMenuItem            replaces primeng/api MenuItem
SuiLazyLoadEvent       replaces primeng/api LazyLoadEvent
SuiDialogRef           replaces primeng/dynamicdialog DynamicDialogRef
SuiButtonVariant       replaces primeng/button ButtonSeverity where needed
T | null               replaces primeng/ts-helpers Nullable<T>
sui z-index tokens     replace primeng/config ZIndex
provideSushi           replaces providePrimeNG
```
