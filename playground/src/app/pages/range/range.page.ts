...
@Component({
  ...
  imports: [Badge, Card, CardTitle, ApiReference, ExampleCode, RangeAppearanceExample, RangeBasicExample, RangeMixerExample],
  templateUrl: './range.page.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RangePage {
  protected readonly api: ApiReferenceData = apiReference.Range;
