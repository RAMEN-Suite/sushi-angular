...
const references: Readonly<Record<string, readonly ApiReferenceData[]>> = {
  ...
  navbar: [
    apiReference.NavbarComponent,
    apiReference.NavbarBrand,
    apiReference.NavbarAction,
    apiReference.Navbar,
    apiReference.NavbarStart,
    apiReference.NavbarCenter,
    apiReference.NavbarEnd,
    apiReference.NavbarContent,
    apiReference.NavbarDropdown,
    apiReference.NavbarLink,
    apiReference.NavbarLinks,
    apiReference.NavbarToggle,
  ],
