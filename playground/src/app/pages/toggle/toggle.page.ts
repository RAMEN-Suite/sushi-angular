...
@Component({
  selector: 'pg-toggle-page',
  imports: [Badge, Card, CardTitle, ApiReference, ExampleCode, ToggleUsageExample],
  templateUrl: './toggle.page.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TogglePage {
  protected readonly api: ApiReferenceData = apiReference.Toggle;
