...
@Component({
  ...
  imports: [MultiSelect, MultiSelectCheckmarkIconTemplate, MultiSelectClearIconTemplate, MultiSelectDropdownIconTemplate, MultiSelectEmptyTemplate, MultiSelectFooterTemplate, MultiSelectHeaderTemplate, MultiSelectLoadingIconTemplate, MultiSelectLoadingTemplate, Spinner, LucideBadgeCheck, LucideChevronsUpDown, LucideCircleX],
